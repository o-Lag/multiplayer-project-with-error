Shader "Trosty/Sketch" {
    Properties {
        _ContourColor ("Contour Color", Color) = (0, 0, 0, 1.0) // Ajuste para garantir contorno opaco
...
#else
            return _ContourColor; // Usa a cor de contorno, que agora tem alfa definido corretamente
#endif
        }
    ENDCG
    SubShader {
        ...
        // Primeiro Pass (Back Cull) - Ajustado Blend
        Pass {
            Cull Back
            Lighting Off
            Blend SrcAlpha OneMinusSrcAlpha // Garantir que o blending respeita o alfa
            CGPROGRAM
        ...
        // Passes subsequentes ajustados com blending correto e Cull Front
        Pass {
            Cull Front
            Lighting Off
